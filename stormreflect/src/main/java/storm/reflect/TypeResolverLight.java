...
public final class TypeResolverLight {
     ...
     * @return argument for {@code type} else {@link storm.reflect.TypeResolverLight.Unknown} if no type arguments are declared
     ...
     * @param subType to extract type variable information from
     * @return argument for {@code genericType} else {@link storm.reflect.TypeResolverLight.Unknown} if no type arguments are declared
