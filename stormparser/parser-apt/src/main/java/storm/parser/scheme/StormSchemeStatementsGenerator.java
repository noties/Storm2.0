...
class StormSchemeStatementsGenerator implements StormScheme {
    ...
    public List<String> onCreate() throws StormSchemeException {
        ...
        final List<StormParserColumn> columns = mTable.getElements();
    ...
    static String getColumnCreateStatement(StormParserColumn column) {
    ...
    static String getAlterTableAddColumnStatement(String tableName, StormParserColumn column) {
